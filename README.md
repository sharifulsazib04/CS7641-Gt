...
## 5. Conclusion
We have implemented supervised learning with CNN and unsupervised learning with Kmeans and GMM. The performance of supervised learning with CNN is superior to that of unsupervised learning. The performance of our methods depend on the overall image quality, uniformity and variety of images in the classes of dataset. Traffic sign recognition system is very sensetive in practical purposes. One misrecognition can lead to catastrophic event. Thats why this system has to be a flawless one. So there is always scope of improvement in this field of application of machine learning.
